...
namespace The_Last_Trial
{
    class Son
    {
        private static SoundEffect[] mySound = new SoundEffect[6];
        ...
        {
            mySound[0] = Content.Load<SoundEffect>("sound/soundTrack/0");
            ...
            mySound[5] = Content.Load<SoundEffect>("sound/soundTrack/1");
        }
